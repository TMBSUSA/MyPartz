...
class Partdetail extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['PartName', 'PartDetails', 'PartCondition', 'YearFrom', 'YearTo', 'PartPrice', 'UserId', 'PartTypeId', 'VehiclemakeId', 'VehicleModelId', 'Location', 'Status'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'YearFrom' => 'Compatibility - Year From',
            'YearTo' => 'Compatibility - Year To',
