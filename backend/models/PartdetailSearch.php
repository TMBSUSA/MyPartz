...
class PartdetailSearch extends Partdetail
{
    ...
    public function rules()
    {
        return [
            [['PartId'], 'integer'],
            [['UserId', 'PartTypeId', 'VehiclemakeId', 'VehicleModelId', 'PartName', 'PartDetails', 'PartCondition', 'YearFrom', 'Lat', 'Lng', 'Location', 'Status', 'CreatedOn', 'UpdatedOn'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'PartName', $this->PartName])
            ...
            ->andFilterWhere(['like', 'YearFrom', $this->YearFrom])
